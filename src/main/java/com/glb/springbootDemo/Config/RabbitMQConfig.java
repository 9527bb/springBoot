package com.glb.springbootDemo.Config;
...
/**
 * 分别是 Direct，Topic，Fanout，Headers 模式。
 *
...
public class RabbitMQConfig {
    ...
    public static final String DIRECT_ROUTINGKEY1 = "apple";
    public static final String DIRECT_ROUTINGKEY2 = "orange";
